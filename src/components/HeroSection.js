...
import set_premium_opis_480px from "../images/set_premium_opis_480px.png"
import set_premium_cena_480px from "../images/set_premium_cena_480px.png"
...
function HeroSection() {
  ...
  return (
    <div className="hero-container">
      ...
      <div className="img-container">
        <div className="self-img-container-right">
          <img src={mobile ? set_premium_opis_480px : set_premium_opis_480px} alt="" margin="auto"></img>
        </div>
        <div className="self-img-container-left">
        <img src={mobile ? set_premium_cena_480px : set_premium_cena_480px} alt="" margin="auto"></img>
        </div>
      </div>
    </div>
  )
